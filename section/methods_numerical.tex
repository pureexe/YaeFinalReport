...
\hspace{1cm} คณะวิจัย \cite{ref:ROF-template} ได้แนะนำวิธีการเชิงตัวเลขสำหรับการกำจัดสัญญาณรบกวนโดยใช้วิธีการเดินเวลาแบบชัดแจ้ง ซึ่งวิธีการเชิงตัวเลขดังกล่าวสามารถประยุกต์ใช้เพื่อแก้สมการ \ref{e3} สามารถประยุกต์เป็นวิธีเชิงตัวเลขสำหรับการต่อเติมภาพได้ดังนี้
...
\hspace{1cm} หลังจากใช้การประมาณแบบไฟไนต์ดิฟเฟอร์เรนจ์ดังที่กล่าวในตอนต้นจะได้รูปแบบการทำซ้ำเป็น 
\begin{align}
