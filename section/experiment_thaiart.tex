...
\input{figure/synart_original}
\input{figure/synart_toinpaint}
...
\input{figure/result-timemarching}
\input{table/result-timemarching}

\input{figure/result-fixpoint}
\input{table/result-fixpoint}	


\input{figure/result-splitbregman}
\input{table/result-splitbregman}

\hspace{1cm} ประสิทธิภาพของวิธีการเชิงตัวเลขทั้ง 3 วิธี สามารถสรุปได้ดังนี้
\input{table/result-inpaint-average}
\hspace{1cm} 
...
\input{table/multiresolution}
\input{table/multiresolution-summary}
...
\input{table/multiresolution2}
\input{table/multiresolution2-summary}
...
\input{figure/thaiart_original}
\input{figure/thaiart_toinpaint}
...
\input{figure/ex4-splitbregman}
\input{table/ex4-splitbregman}

\input{figure/ex4-multiresolution}
\input{table/ex4-multiresolution}

\hspace{1cm}ทั้งสองวิธี ได้ผลลัพธ์การซ่อมแซมภาพศิลปะไทยในรูปค่าเฉลี่ยออกมาดังนี้

\input{table/ex4-summary}
